...
activities = {
    ...
    "Basketball Club": {
        "description": "Skill drills, scrimmages, and competitive games",
...
def signup_for_activity(activity_name: str, email: str):
    ...
    # Validate student is not already signed up in a case-insensitive way
    if email.lower() in (participant.lower() for participant in activity["participants"]):
